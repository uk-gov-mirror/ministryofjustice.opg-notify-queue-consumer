...
class SqsAdapterTest extends TestCase
{
    ...
    public function setUpWithVcrCassette(string $cassette): void
    {
        global $awsSqsClient;
        ...
        $queueName = strtolower('v001_queue_' . $cassette);
...
//        $this->awsSqsClient->deleteQueue(['QueueUrl' => $this->queueUrl]);
    ...
    {
        $this->setUpWithVcrCassette('test_sqsadapter_retrieve_message');
    ...
    {
        $this->setUpWithVcrCassette('test_sqsadapter_delete_message');
        ...
        $this->queueAdapter->delete(
            SendToNotify::fromArray(
                [
                    'id' => $message->getId(),
                    'documentId' => 123,
                    'uuid' => 'any',
